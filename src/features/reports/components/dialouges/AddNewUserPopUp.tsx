          ...
          <div className='flex flex-col gap-[20px]'>
            <div className='flex flex-col gap-[15px]'>
             <div className="flex items-center gap-[12px]">
                      ...
                      <div className='text-[14px] text-app-greyText'>A user that is a Portfolio Administrator will be allowed to add and remove users, accounts, and payment methods.</div>
                      </div>
                       <div className='flex flex-col gap-[15px]'>
                       <div className="flex items-center gap-[12px]">
                        <Checkbox
                       ...
                       <div className='text-[14px] text-app-greyText'>Once saved, this user will automatically receive an email with password setup and login instructions.</div>
                       </div>
          </div>
