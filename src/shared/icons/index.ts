...
export { default as BuildLeadPlus } from './svg/BuildLeadPlus.svg'
export { default as Person } from './svg/Person.svg'
export { default as Payment } from './svg/Payment.svg'
export { default as Notification } from './svg/Notification.svg'
export { default as PersonImage } from './images/PersonImage.png'
export { default as Update } from './svg/Update.svg'
